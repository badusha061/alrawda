        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <a href="https://pagedone.io/"  className="flex justify-center lg:justify-start">
                        <Image className=" rounded-xl object-cover" width={150} height={300} src="https://res.cloudinary.com/dzvxebtnl/image/upload/v1745081051/al%20rawda/brmdxmdyusrhc2aq12oy.jpg" alt='log image' />
                    </a>
                    <p className={`${inter.className} py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left`}>AL RAWDA Company able to do this through a commitments to install high quality products at a firprice</p> 
                    <Link href='/contact' >
                        <Button className={`${poppins.className} py-2.5 px-5 h-9 block w-fit bg-[rgb(8,116,156)] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:[rgb(8,116,156)]  hover:cursor-pointer  lg:mx-0`} >
                            Contact us
                        </Button>
                    </Link>
                ...
                <div className="lg:mx-auto text-left ">
                    <h4 className={`${poppins.className} text-lg text-gray-900  mb-7`}>AL RAWDA</h4>
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6">
                            <Link href='/' >
                                <p className={`${inter.className} text-gray-600 hover:text-gray-900`}>
                                    Home
                                </p>
                            </Link>
                        </li>
                ...
                <div className="lg:mx-auto text-left ">
                    <h4 className={`${poppins.className} text-lg text-gray-900  mb-7`}>Services</h4>
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6">
                            <p className={`${inter.className} text-gray-600 hover:text-gray-900`}>
                                Raditation protection & X-ray 
                            </p>
                        </li>
                        <li className="mb-6">
                            <p className={`${inter.className} text-gray-600 hover:text-gray-900`}>
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">AL RAWDA</a> 2025, All rights reserved.</span>
